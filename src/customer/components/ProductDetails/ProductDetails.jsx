...
export default function ProductDetails() {
  ...
  const handleAddToCart = () => {
    const data={product: params.productId, size:selectedSize.name}
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          ...
          >
            {pro.breadcrumbs.map((breadcrumb) => (
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                <Button
                  ...
                  variant="contained"
                  sx={{ px: "2rem", py: "1rem", bgcolor: "#9155fd", mt: 1 }}
                >
                  Add to Cart
                </Button>
              </form>
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">{pro.details}</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    readOnly
                  />
                  <p className="opacity-60">34567 Ratings</p>
                </div>
